...
public class Anomaly {
	...
	public String anomaly(@UdfParameter("sensorinput") String sensorinput) {
	  ...
	  GenModel rawModel;
		...
		// p outputs -> original, recontructed, recontstructedRowData
		// orignal - Representation of the original input the way AutoEncoder model sees it (1-hot encoded categorical values)
		// reconstrcuted - Reconstructed data, the array has same length as the original input.
